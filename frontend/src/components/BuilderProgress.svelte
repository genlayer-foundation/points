...
<div class="bg-white rounded-lg p-5 border border-{colorTheme}-200">
  ...
  <div class="max-w-2xl">
      ...
      <div>
        {#if !hasValidatorWelcome && showActions}
          <button
            ...
            class="px-3 py-1 bg-sky-50 text-sky-700 text-xs font-medium rounded-md hover:bg-sky-100 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
          >
      ...
      <div>
        {#if showActions && testnetBalance !== null && testnetBalance === 0}
          <a
            ...
            class="px-3 py-1 bg-{colorTheme}-50 text-{colorTheme}-700 text-xs font-medium rounded-md hover:bg-{colorTheme}-100 transition-colors flex items-center whitespace-nowrap"
          >
            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="grid grid-cols-[auto,1fr,auto] gap-3 items-start opacity-60">
      <div class="mt-0.5">
        <div class="w-5 h-5 rounded-full bg-gray-100 border-2 border-gray-300 flex items-center justify-center">
      ...
      <div>
        {#if showActions}
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="px-3 py-1 bg-gray-100 text-gray-600 text-xs font-medium rounded-md hover:bg-gray-200 transition-colors flex items-center whitespace-nowrap"
          >
            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
