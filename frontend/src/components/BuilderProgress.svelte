      ...
      <div class="flex items-center justify-between">
        ...
        {#if showActions && !githubUsername}
          <GitHubLink
            ...
            buttonClass="px-3 py-1 bg-orange-500 text-white text-xs font-medium rounded-md hover:bg-orange-600 transition-colors flex items-center whitespace-nowrap"
