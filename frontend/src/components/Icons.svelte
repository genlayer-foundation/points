<script context="module">
  ...
  export const icons = {
    ...
    validator: 'M12 2L3.5 7v6c0 5.55 3.84 10.74 8.5 12 4.66-1.26 8.5-6.45 8.5-12V7L12 2zm2 5h-3l-1 5h3l-3 7 5-8h-3l2-4z',
...
<script>
  ...
  const fillIcons = ['genlayer', 'global', 'builder', 'validator', 'steward', 'leaderboard'];
