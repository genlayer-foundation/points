  ...
  const baseRoles = [
    {
      ...
      description: 'Deploy Intelligent Contracts, ship projects, and earn Builder Points for every accepted contribution.',
    ...
    },
    {
      ...
      description: 'Join the waitlist, run nodes on the testnet, and earn Validator Points for uptime and infrastructure.',
    ...
    },
    {
      ...
      description: 'Create content, participate in events, and grow the GenLayer ecosystem to earn Community Points.',
