...
import { computeNormalizedUrl, normalizeLocation } from '../lib/normalizePath.js';
...
describe('computeNormalizedUrl', () => {
  ...
  it('leaves reserved/server-handled prefixes untouched', () => {
  ...
  it('tolerates missing hash/search fields', () => {
...
describe('normalizeLocation', () => {
  ...
  it('returns false safely when window/history is unavailable', () => {
