  ...
  async function startCreatorJourney() {
    ...
    try {
      ...
      if (response.status === 201 || response.status === 200) {
        ...
        showSuccess('You are now a Community Member! Start growing the community through referrals.');

        // Reload participant data to get Community profile (same pattern as Builder)
        const updatedUser = await getCurrentUser();
        participant = updatedUser;
      }
    } catch (err) {
    ...
    {#if !hasAnyRole && !isValidatorOnly && isOwnProfile}
      ...
      <div class="bg-white border border-gray-200 rounded-lg shadow-sm mb-6">
        ...
        <div class="p-6">
          ...
          <!-- Become a Community Member Section (Below the two journey cards) -->
          <div class="mt-6">
            <div class="group relative bg-purple-50 border-2 border-purple-200 rounded-xl overflow-hidden hover:shadow-lg transition-all">
              ...
              <div class="relative p-6">
                <div class="flex items-center mb-4">
                  ...
                  <div>
                    <h3 class="text-xl font-bold text-purple-900 mb-1">Join the Community</h3>
