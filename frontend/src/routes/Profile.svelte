            ...
            <div class="bg-white rounded-lg p-5 mb-6 border border-orange-200">
              ...
              <div class="mt-5 flex items-center justify-between">
                <div class="text-xs text-gray-500">
                  <span class="font-medium">{1 + (testnetBalance && testnetBalance > 0 ? 1 : 0)} of 4</span> requirements completed
                </div>
                <button
                  onclick={() => push('/submit-contribution')}
                  class="inline-flex items-center px-4 py-2 bg-orange-500 text-white text-sm font-medium rounded-lg hover:bg-orange-600 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                >
