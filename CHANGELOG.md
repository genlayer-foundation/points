...
- Projects and Milestones are now separate contribution types: Projects submissions require the project's GitHub repository as evidence and create a project profile when accepted, while builders with an accepted project can submit Milestones — auto-versioned progress updates (v1, v2, ...) linked to that project, where the written explanation of changes is required, extra evidence is optional, and stewards review the changes against the project's repository (3e7f4d8)
