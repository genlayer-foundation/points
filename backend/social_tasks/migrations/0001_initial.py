...
SEED_TASKS = [
    ...
    {
        'slug': 'check-out-genlayer-on-x',
        'name': 'Check out GenLayer on X',
        'description': 'Open the GenLayer feed and show some love on the latest posts.',
        'points': 5,
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_url', models.URLField(blank=True, help_text='External URL the user is sent to on click. Leave blank to derive it from the verification target where possible (e.g. the GitHub repo page, or an X follow link for the handle).')),
