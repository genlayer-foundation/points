...
from .views import FeatureCandidateReviewViewSet, StewardViewSet, WorkingGroupViewSet

router = DefaultRouter()
# Register working-groups first to ensure it matches before the catch-all steward route
router.register(r'feature-reviews', FeatureCandidateReviewViewSet, basename='feature-review')
