    ...
    "ImageRepository": {
      ...
      "ImageConfiguration": {
        ...
        "RuntimeEnvironmentSecrets": {
          ...
          "EMAIL_HOST": "$SSM_PREFIX/prod/email_host",
          "EMAIL_PORT": "$SSM_PREFIX/prod/email_port",
          "EMAIL_USE_TLS": "$SSM_PREFIX/prod/email_use_tls",
          "EMAIL_HOST_USER": "$SSM_PREFIX/prod/email_host_user",
          "EMAIL_HOST_PASSWORD": "$SSM_PREFIX/prod/email_host_password",
          "DEFAULT_FROM_EMAIL": "$SSM_PREFIX/prod/default_from_email",
          "TURNSTILE_SECRET_KEY": "$SSM_PREFIX/prod/turnstile_secret_key",
          "TURNSTILE_ALLOWED_HOSTNAMES": "$SSM_PREFIX/prod/turnstile_allowed_hostnames",
          "EMAIL_VERIFICATION_HMAC_KEY": "$SSM_PREFIX/prod/email_verification_hmac_key",
          "EMAIL_VERIFICATION_ENCRYPTION_KEY": "$SSM_PREFIX/prod/email_verification_encryption_key",
          ...
          "GRAFANA_API_TOKEN": "$SSM_PREFIX/prod/grafana_api_token",
          ...
          "SORSA_API_KEY": "$SSM_PREFIX/prod/sorsa_api_key",
